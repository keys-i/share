...
describe("Breadcrumb", () => {
  ...
  it("should call onNavigate with empty string when clicking repo name", () => {
    ...
    render(<Breadcrumb repoName="test-repo" path="src/index.ts" onNavigate={onNavigate} />);
  ...
  it("should call onNavigate with path when clicking intermediate segment", () => {
    const onNavigate = vi.fn();
    render(<Breadcrumb repoName="test-repo" path="src/lib/utils.ts" onNavigate={onNavigate} />);
