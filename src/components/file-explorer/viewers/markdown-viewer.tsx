...
export function MarkdownViewer({ file, owner, repo, branch }: MarkdownViewerProps) {
        ...
        rehypePlugins={[
          ...
          [
            rehypeSanitize,
            {
              ...
              tagNames: [...(defaultSchema.tagNames || []), "img", "details", "summary"],
            },
          ],
        ]}
        components={{
          ...
          img({ node, src, alt, ...props }) {
            const resolvedSrc = src ? resolveRelativeUrl(src, file.path, owner, repo, branch, file.download_url) : "";
