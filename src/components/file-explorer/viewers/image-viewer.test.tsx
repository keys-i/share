...
const createMockFile = (overrides: Partial<FileContent> = {}): FileContent => ({
  ...
  download_url: "https://raw.githubusercontent.com/owner/repo/main/images/test-image.png",
  ...overrides,
});
...
describe("ImageViewer", () => {
  it("should render image with base64 data URI for base64 encoded content", () => {
    ...
    expect(img).toHaveAttribute("src", "data:image/jpeg;base64,aGVsbG8gd29ybGQ=");
  });
  ...
  it("should use correct MIME type for different image formats", () => {
    ...
    expect(img).toHaveAttribute("src", expect.stringContaining("image/svg+xml"));
  });
});
