...
export const handlers = [
  ...
  http.get("https://api.github.com/repos/:owner/:repo/contents/:path*", ({ params }) => {
    ...
    const name = Array.isArray(pathSegments) ? pathSegments[pathSegments.length - 1] : pathSegments;
    return HttpResponse.json({
      ...mockFileContent,
      path: pathStr,
      name: name,
...
export const rateLimitHandler = http.get("https://api.github.com/repos/:owner/:repo", () => {
  return HttpResponse.json(
    {
...
export const notFoundHandler = http.get("https://api.github.com/repos/:owner/:repo", () => {
  return HttpResponse.json(
    {
      message: "Not Found",
...
export const unauthorizedHandler = http.get("https://api.github.com/user", () => {
  return HttpResponse.json(
    {
